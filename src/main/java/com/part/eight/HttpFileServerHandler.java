...
public class HttpFileServerHandler extends
        ...
        sendFileFuture.addListener(new ChannelProgressiveFutureListener() {
            public void operationProgressed(ChannelProgressiveFuture channelProgressiveFuture
                ...
                if (total < 0) {
                    ...
                    System.err.println("Transfer pregress:" + progress + "/" + total);
                }
            }
    ...
    private static void sendRedirect(ChannelHandlerContext ctx,String newUri){
        FullHttpResponse respons = new DefaultFullHttpResponse(HttpVersion.HTTP_1_1
                ,HttpResponseStatus.FOUND);
        respons.headers().set(HttpHeaderNames.LOCATION,newUri);
        ctx.writeAndFlush(respons).addListener(ChannelFutureListener.CLOSE);
    }
